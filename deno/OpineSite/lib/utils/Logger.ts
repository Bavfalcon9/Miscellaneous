...
class Logger {
     ...
     public static HARD_ENABLE: boolean = false;
     private name: string;
     ...
     public critical(msg: string, ...extra: any[]): void {
          msg = this.name + Colors.bold(Colors.rgb24('Critical Error!', 0xe80013)) + ': ' + Colors.rgb24(msg, 0xff4a59);
          this.log(msg, ...extra);
     }

     public error(msg: string, ...extra: any[]): void {
          msg = this.name + Colors.bold(Colors.rgb24('Error!', 0xff4a4a)) + ': ' + Colors.rgb24(msg, 0xfc7e7e);
          this.log(msg, ...extra);
     }

     public warn(msg: string, ...extra: any[]): void {
          msg = this.name + Colors.bold(Colors.rgb24('Warn!', 0xffe96b)) + ': ' + Colors.rgb24(msg, 0xfaeda2);
          this.log(msg, ...extra);
     }

     public notice(msg: string, ...extra: any[]): void {
          msg = this.name + Colors.bold(Colors.rgb24('Notice!', 0x55f7ff)) + ': ' + Colors.rgb24(msg, 0x93e9ed);
          this.log(msg, ...extra);
     }
     ...
     // notice: 0x55f7ff
     private logColor(color: any, msg: string, ...extra: any[]): void {
